...
//        position = new Vector2D(300, 300); vi o ham cha da khoi tao
...
//            bullets.add(bullet3);
            ...
            for (int i = 0; i < numberBullet;i++){
                ...
                double angle = fomAngle + i * (toAngle - fomAngle)/ (numberBullet - 1);
